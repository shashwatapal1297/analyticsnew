...
women
plot(women)
plot(women, type='p', pch=13)
plot(women, type='l')
plot(women, type='b', pch=18, lty=2, col='green',lwd=4)
...
plot(women)
abline(lm(women$weight ~ women$height), col='red', lty=2, lwd=4)#from regression
...
summary(women)
quantile(women$height)#same as quartile
...
#histogram2
x = rnorm(100,50,100) #normally distributed data
hist(x)
