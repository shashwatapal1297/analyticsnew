df= read.csv('C:/rWork/rProjects/analytics1/data/data.csv')
head(df)
df1=read.csv(file=file.choose()) #helps us explore and find the necessary file to be imported
df
head(df)
#writing to excel,exporting
#save an excel file into specific location
write.csv(mtcars,file = 'C:/rWork/rProjects/analytics1/data/mtcars.csv')
...
df= read.csv('./data/mtcars.csv')#reading from file
str(df)
